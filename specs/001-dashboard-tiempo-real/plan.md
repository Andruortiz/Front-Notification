...
como Fase 0 del *implement*, no como excepciones a la constitución.
...
*Sin violaciones que requieran justificación — ver Constitution Check arriba: los dos gates con
acción previa (I, III) se resuelven como tareas dentro de esta misma historia, no como excepciones.*
